...
public class JacksonInteractionLayer {


    protected final File file;
    private final ArrayList<Object> daoInstances;

    public JacksonInteractionLayer(String filePath) {
        this.file = new File(filePath);
        this.daoInstances = new ArrayList<>();
        this.daoInstances.add(new JacksonStudentDAO(filePath));
        ...
        while (processMenu) {
            ...
            try {
                ...
                if(daoNum==-1){
                    ...
                    if(daoInstances.get(daoNum) instanceof JacksonAbstractDAO<?,?> dao){
